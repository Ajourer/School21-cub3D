...
//	printf("%d\n", key);
	...
	if (key == 124)
	{
		...
		all->info->dir_x = all->info->dir_x  * cos(0.07) - all->info->dir_y * sin(0.07);
		all->info->dir_y = old_dir_x * sin(0.07) + all->info->dir_y * cos(0.07);
		old_plane_x = all->info->plane_x;
		all->info->plane_x = all->info->plane_x * cos(0.07) - all->info->plane_y *
			sin(0.07);
		all->info->plane_y = old_plane_x * sin(0.07) + all->info->plane_y * cos(0.07);
	}
	if (key == 123)
	{
		float old_dir_x;
